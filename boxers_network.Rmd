...
- fix boxer name in dataframe. wrong boxer is attached to datadrame bc it gets
  out of order when looping through
- rowbind dfs then filter so u dont need another loop
